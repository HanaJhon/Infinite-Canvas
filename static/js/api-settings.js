...
let providerDragId = '';
// category: 'value'（性价比），推荐面板展示性价比 API
const RECOMMENDED_APIS = [
{
  ...
  register_url: 'https://grsai.com/zh/dashboard/api-keys',
...
},
{
  ...
  protocol: 'openai',
  image_request_mode: 'general',
  register_url: 'https://api1.qlhazycoder.top/keys',
  tagKeys: ['api.tagLlmModels'],
  icons: ['IMG', 'LLM'],
  summaryKey: 'Coder超性价比LLM模型，推荐优先特惠分组',
  advantages: ['Coder 性价比 LLM', '支持 /v1/images/generations 和 /v1/chat/completions'],
  image_models: ['gpt-image-2'],
  chat_models: ['coder-llm'],
  video_models: []
}
];
...
function isFixedProvider(itemOrId){
    ...
    return id === 'runninghub' || id === 'volcengine';
}
...
function sortedProviders(){
    const order = ['runninghub', 'volcengine'];
