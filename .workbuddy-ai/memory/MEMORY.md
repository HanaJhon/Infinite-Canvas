...
> 索引式硬规则。细节全部下沉到同目录 `REFERENCE.md`（A 启动器 / B `.git` 事故 / C 项目胶囊 / D API Key / E 磁盘清理 / F Grsai 模型 / G 磁盘补充 / H 3D 白模工作室 / I 保存接口与 logs 坑 / J 前端要点 / K 3D 节点界面 / L 服务与 git 红线）；过程记录见 `YYYY-MM-DD.md`。
